...
public class PayLogController {
    ...
    /**
     * 显示支付日志列表，实现按日期、状态、用户进行查询
     *
     * @return
     */
    @ApiOperation(value = "显示支付日志列表，实现按日期、状态、用户进行查询。", notes = "显示支付日志列表，实现按日期、状态、用户进行查询。", tags = {"PayLogController"})
    @PostMapping(value = "/search/parameter/{search}")
    public Result<List<PayLog>> findPayLogByList(@PathVariable("search") String search) {
        List<PayLog> list = payLogService.findPayLogByList(search);
