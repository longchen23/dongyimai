...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public PageResult<PayLog> findPage(int page, int size) {
        Page<PayLog> mypage = new Page<>(page, size);
        IPage<PayLog> iPage = this.page(mypage, new QueryWrapper<>());
     ...
     */
    @Override
    public List<PayLog> findPayLogByList(String search) {
        QueryWrapper<PayLog> queryWrapper = new QueryWrapper<>();
        queryWrapper.or().eq("user_id", search);
        queryWrapper.or().like("pay_time", search);
        queryWrapper.or().eq("trade_state", search);
        return this.list(queryWrapper);
    }
